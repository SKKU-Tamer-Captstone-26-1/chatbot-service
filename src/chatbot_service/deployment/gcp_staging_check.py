...
REQUIRED_PIPELINE_TOKENS = (
    ...
    "--wait",
    "--set-env-vars=",
    "_RECOMMENDATION_SERVICE_GRPC_ADDR",
    "_RECOMMENDATION_SERVICE_GRPC_TLS",
    "_RECOMMENDATION_SERVICE_SERVERLESS_AUTH_MODE",
    "_RECOMMENDATION_SERVICE_SERVERLESS_AUDIENCE",
    "_CHATBOT_LLM_ENDPOINT_URL",
    "_CHATBOT_LLM_MODEL",
    "_CHATBOT_LLM_AUTH_MODE",
    "_CHATBOT_LLM_SERVERLESS_AUTH_MODE",
    "_CHATBOT_LLM_SERVERLESS_AUDIENCE",
    "--set-secrets=",
