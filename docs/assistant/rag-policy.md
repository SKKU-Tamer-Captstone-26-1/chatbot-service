...
This document defines how RAG is allowed to work in `ai-assistant-service`.
...
If the assistant has no retrieved evidence, it must not answer with invented knowledge.
...
Each assistant response should internally store:
