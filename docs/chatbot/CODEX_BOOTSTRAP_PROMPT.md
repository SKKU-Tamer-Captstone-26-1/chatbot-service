# Codex Bootstrap Prompt for AI Chatbot Service

Use this prompt when starting the first agent task in the AI chatbot repository.

```text
We are building the ONTHEBLOCK AI chatbot service.
...
- Chatbot conversations should be stored for future evaluation/training, but do not implement model training yet.
...
2. Confirm whether docs/chatbot exists.
3. Confirm whether proto/chatbot/v1/chatbot.proto exists.
4. Confirm whether src/chatbot_service exists.
